...
{
    public partial class MaUserDefaultWms
    {
        ...
        public string Grstorage { get; set; }
        public string GrconsignmentStorage { get; set; }
        public string Psstorage { get; set; }
        public string PsconsignmentStorage { get; set; }
