...
{
    public partial class ImSubcontractWprdetails
    {
        ...
        public short? SubcontractOrdLine { get; set; }
        public string Job { get; set; }
        public short JobSection { get; set; }
        public int JobLineId { get; set; }
        public string JobWorkingStep { get; set; }
        public int? SrcSubcontractWprid { get; set; }
        public double? SrcSubcontractWprqty { get; set; }
