...
{
    public partial class ImSubcontractWprpreviousWpr
    {
        public int SubcontractWprid { get; set; }
        public short Line { get; set; }
        public int? PreviousWprid { get; set; }
        public string PreviousWprno { get; set; }
        public DateTime? PreviousWprdate { get; set; }
