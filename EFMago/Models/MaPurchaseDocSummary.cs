...
{
    public partial class MaPurchaseDocSummary
    {
        ...
        public double? GoodsAmountToCheck { get; set; }
        public double? TaxableAmountToCheck { get; set; }
        public double? TotalAmountToCheck { get; set; }
        public double? PayableAmountToCheck { get; set; }
        public string StampsChargesTaxCode { get; set; }
        public string CollectionChargesTaxCode { get; set; }
        public string TaxSummaryIsManual { get; set; }
