...
{
    public partial class MaJournalEntriesTaxDetail
    {
        ...
        public double? FiscalTaxableAmt { get; set; }
        public double? FiscalTaxAmt { get; set; }
        public double? FiscalTotalAmt { get; set; }
        public double? FiscalUndeductible { get; set; }
