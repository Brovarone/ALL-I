...
namespace EFMago.Models
{
    public partial class MaCustSupp
    {
        public MaCustSupp()
        {
            ImSuppliersDiscounts = new HashSet<ImSuppliersDiscounts>();
            MaCreditCustomerDocument = new HashSet<MaCreditCustomerDocument>();
            MaCustSuppBalances = new HashSet<MaCustSuppBalances>();
            MaCustSuppBranches = new HashSet<MaCustSuppBranches>();
            MaCustSuppBudget = new HashSet<MaCustSuppBudget>();
            MaCustSuppCircularLetters = new HashSet<MaCustSuppCircularLetters>();
            MaCustSuppNotes = new HashSet<MaCustSuppNotes>();
            MaCustSuppOutstandings = new HashSet<MaCustSuppOutstandings>();
            MaCustSuppPeople = new HashSet<MaCustSuppPeople>();
        }
        ...
        public virtual MaCustSuppCustomerOptions MaCustSuppCustomerOptions { get; set; }
        public virtual MaCustSuppNaturalPerson MaCustSuppNaturalPerson { get; set; }
        public virtual MaCustSuppSupplierOptions MaCustSuppSupplierOptions { get; set; }
        public virtual ICollection<ImSuppliersDiscounts> ImSuppliersDiscounts { get; set; }
        public virtual ICollection<MaCreditCustomerDocument> MaCreditCustomerDocument { get; set; }
        public virtual ICollection<MaCustSuppBalances> MaCustSuppBalances { get; set; }
        public virtual ICollection<MaCustSuppBranches> MaCustSuppBranches { get; set; }
        public virtual ICollection<MaCustSuppBudget> MaCustSuppBudget { get; set; }
        public virtual ICollection<MaCustSuppCircularLetters> MaCustSuppCircularLetters { get; set; }
        public virtual ICollection<MaCustSuppNotes> MaCustSuppNotes { get; set; }
        public virtual ICollection<MaCustSuppOutstandings> MaCustSuppOutstandings { get; set; }
        public virtual ICollection<MaCustSuppPeople> MaCustSuppPeople { get; set; }
    }
}
