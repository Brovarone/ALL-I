...
{
    public partial class MaUserDefaultSales
    {
        public string Branch { get; set; }
        public int WorkerId { get; set; }
        public string Storage { get; set; }
        public string InvoiceAccTpl { get; set; }
        public string AccompanyingInvoiceAccTpl { get; set; }
        ...
        public string ReceiptsAccTpl { get; set; }
        public string NcreceiptsTaxJournal { get; set; }
        ...
        public string ReceiptAccRsn { get; set; }
        public string DninvRsn { get; set; }
        ...
        public string GoodsSalesAccount { get; set; }
        public string ServicesSalesAccount { get; set; }
        public string SundryRevenuesAccount { get; set; }
        public string FreeSamplesAmount { get; set; }
        public string Advance { get; set; }
        public string FreeSamplesTaxAmount { get; set; }
        public string NcreceiptsAccTpl { get; set; }
        public string ReturnedMaterialInvRsn { get; set; }
        public string CorrectionInvoiceAccTpl { get; set; }
        public string CorrectionReceiptsAccTpl { get; set; }
        public string ReturnFromCustomerInvRsn { get; set; }
        public string InvoiceFromParagonTaxJournal { get; set; }
        public string InvoiceFromParagonAccTpl { get; set; }
        public string DummyCustomer { get; set; }
        public string InvoiceCorrectionRsn { get; set; }
        public string LoadDnrsn { get; set; }
        public string InvoiceCorrectionRsnReturn { get; set; }
        public string CreditNoteInvRsn { get; set; }
        public string InvoiceForAdvanceAccTpl { get; set; }
        ...
        public string CorrAccInvoiceAccTpl { get; set; }
        public string InvoiceForAdvanceAccount { get; set; }
        public string IrstorageTransfer { get; set; }
        public string IrstorageTransferOut { get; set; }
        public string IrstorageTransferIn { get; set; }
        public string IrnotOwnedStorageTransferOut { get; set; }
        public string IrnotOwnedStorageTransferIn { get; set; }
        ...
        public string PickingListInvRsn { get; set; }
        ...
        public string ReceiptIsminvRsn { get; set; }
        public DateTime Tbcreated { get; set; }
        public DateTime Tbmodified { get; set; }
        public int TbcreatedId { get; set; }
        public int TbmodifiedId { get; set; }
        public string TaxBreakReason { get; set; }
        public string TaxBreakAccount { get; set; }
    }
}
