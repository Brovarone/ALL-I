...
Module Contab_addon
    ...
    ''' </summary>
    Public Function CreaFattureDaEmettere(ByVal r As DataTable, ByVal withAnalitica As Boolean, ByVal data As Date) As Boolean
                                                                ...
                                                                Try
                                                                    ...
                                                                    If isAnalitico Then
                                                                        ...
                                                                        With drPnD
                                                                            ...
                                                                            Dim annoLavoro As Integer = dataRiga.Year
                                                                            Dim dataTemp As Date
                                                                            If Not DateTime.TryParse(nomeMese & " 1, " & annoLavoro.ToString(), culture, DateTimeStyles.None, dataTemp) Then
                                                                                dataTemp = data ' Fallback
                                                                            End If
                                                                            Dim dataDecorrenza As New Date(annoLavoro, dataTemp.Month, Date.DaysInMonth(dataTemp.Year, dataTemp.Month))
